...
namespace SellWebsite.Areas.Customer.Controllers
{
    ...
    public class HomeController : Controller
    {
        ...
        {
            return Json(new { data = _unitOfWork.Category.GetAll().Select(p => p.Name).ToList() });
        }
        ...
        public IActionResult Detail(int id)
        {
            ...
            {
                Product = _unitOfWork.Product.Get(x => x.ProductId == id, p => p.Categories!),
                ProductId = id,
            };
            return View(cart);
        }
        ...
        public IActionResult AddToCart(int productId)
        {
            ...
            if (claimIdentity.Name != null)
            {
                ...
                else
                {
                    ...
                    {
                        Product = _unitOfWork.Product.Get(x => x.ProductId == productId, p => p.Categories!),
                        ProductId = productId,
